...
This was my [10-th year](/icfpc.html) participating in ICFPC.
...
The desired map is everything inside the traversed contour (white):

<img src="img/icfpc-2019/puzzle/3.png" border=2 style="width: 50%;"/>
...
We have a simple UI that shows all our submissions [here](/icfpc/2019/).
...
<img src="img/icfpc-2019/cpu-usage.jpg" style="width: 50%;"/>
