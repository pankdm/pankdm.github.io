...
Initially we were thinking about writing on python, but our other half of the team who were sitting
...
* We implemented a visualizer in jupyter notebook, but it wasn't really useful:
<img src="img/icfpc-2018/visual.png" style="width: 75%;"/>
* We tried to do BFS-like filling in order to not use levitation for layer-grouned figures
